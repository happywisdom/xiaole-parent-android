...
import com.aibasis.applib.controller.HXSDKHelper;
import com.aibasis.parent.Constant;
import com.aibasis.parent.DemoApplication;
import com.aibasis.parent.DemoHXSDKHelper;
import com.aibasis.parent.R;
import com.aibasis.parent.ui.base.BaseActivity;
import com.aibasis.parent.ui.chat.*;
import com.aibasis.parent.ui.entrance.LoginActivity;
import com.aibasis.parent.ui.home.HomeFragment;
import com.aibasis.parent.ui.knowledge.KnowledgeViewPaperFragment;
import com.aibasis.parent.ui.setting.SettingsFragment;
import com.aibasis.parent.db.InviteMessgeDao;
import com.aibasis.parent.db.UserDao;
import com.aibasis.parent.domain.InviteMessage;
import com.aibasis.parent.domain.InviteMessage.InviteMesageStatus;
import com.aibasis.parent.domain.User;
import com.aibasis.parent.utils.CommonUtils;
...
public class MainActivity extends BaseActivity implements EMEventListener {
    ...
    private ChatViewPagerFragment chatViewPagerFragment;
    private SettingsFragment settingFragment;
    private KnowledgeViewPaperFragment knowledgeFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("jijun-test-parentId", sharePreferenceUtil.getParentId());
        DemoApplication.getInstance().setParentId(sharePreferenceUtil.getParentId());
        //----------------------------------------------------------

        // 启动netty链接
        //startService(new Intent(NetworkIntent.ACTION_CONNECT_SESSION));
        ...
        chatViewPagerFragment = new ChatViewPagerFragment();
        settingFragment = new SettingsFragment();
        knowledgeFragment = new KnowledgeViewPaperFragment();
        homeFragment = new HomeFragment();

        fragments = new Fragment[]{homeFragment, knowledgeFragment, chatViewPagerFragment,  settingFragment};
        // 添加显示第一个fragment
    ...
    private void initView() {
        ...
        mTabs[1] = (Button) findViewById(R.id.btn_knowledge);
