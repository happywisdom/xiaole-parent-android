...
import com.aibasis.parent.utils.CameraHelper;
...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("jijun-iscomingCall", "2");
        System.out.println("jijun-iscomingCall 2");
        ...
        Log.i("jijun-iscomingCall", "3");
        System.out.println("jijun-iscomingCall 3");
        ...
        Log.i("jijun-iscomingCall", "4");
        System.out.println("jijun-iscomingCall 4");

        msgid = UUID.randomUUID().toString();

        Log.i("jijun-iscomingCall", "5");
        System.out.println("jijun-iscomingCall 5");

        // 获取通话是否为接收方向的
        isInComingCall = getIntent().getBooleanExtra("isComingCall", false);
        Log.i("jijun-iscomingCall", "" + isInComingCall);
        System.out.println("jijun-iscomingCall " + isInComingCall);
